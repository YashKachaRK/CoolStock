...
export default function Home() {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      .post("http://localhost:5000/addApplication", form)
      .then(() => {
        setApplied(true);
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 glass bg-white/80 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="px-4 py-2 rounded-xl border-2 border-purple-500 text-purple-600 font-semibold hover:bg-purple-50 transition-all"
            >
              Staff Login
            </Link>
          </div>
      ...
      <section className="hero-bg min-h-screen flex items-center justify-center text-white text-center px-6 pt-20">
        <div className="max-w-4xl mx-auto fade-in-up">
          ...
          <p className="text-xl md:text-2xl font-light mb-10 text-white/90 max-w-2xl mx-auto">
            Experience the sweetest scoops in town — delivered fresh to your
            door or pick it up at our store. Every bite, a new adventure! 🎉
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/login"
              className="px-8 py-4 glass text-white font-bold text-lg rounded-2xl hover:bg-white/20 hover:scale-105 transition-all shadow-lg"
            >
              🔐 Staff Login
            </Link>
            <button
              onClick={() => scrollTo("careers")}
              className="px-8 py-4 bg-white/20 text-white font-bold text-lg rounded-2xl hover:bg-white/30 hover:scale-105 transition-all"
            >
              💼 Join Our Team
            </button>
          </div>
      ...
      <section id="about" className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 max-w-3xl mx-auto mb-16">
            CoolStock is a modern Ice Cream shop powered by a cutting-edge
            Point-of-Sale (POS) system. We combine a love for creamy,
            handcrafted flavours with the convenience of technology — so you can
            order online, track your delivery, and earn loyalty points, all in
            one place.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(124,58,237,0.25)] transition duration-300 bg-gradient-to-br from-purple-50 to-indigo-100 rounded-3xl p-8 text-left">
              ...
              <p className="text-gray-500">
                Browse our full menu from anywhere, add to cart, and have your
                favourite scoops delivered straight to your door.
              </p>
            </div>
            <div className="hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(124,58,237,0.25)] transition duration-300 bg-gradient-to-br from-pink-50 to-rose-100 rounded-3xl p-8 text-left">
              ...
              <p className="text-gray-500">
                Our dedicated delivery team ensures your order arrives fresh and
            ...
            <div className="hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(124,58,237,0.25)] transition duration-300 bg-gradient-to-br from-orange-50 to-yellow-100 rounded-3xl p-8 text-left">
              ...
              <p className="text-gray-500">
                Our in-store technology streamlines operations for cashiers,
                managers, and admins — making every transaction seamless.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-16">
            Our system serves multiple roles, each with a tailored experience.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              ...
              title="Administrator"
              desc="Full system control — manage employees, products, orders, and analytics from a powerful central dashboard."
            />
            <FeatureCard
              icon="👨‍🍳"
              bg="bg-green-100"
              ...
              title="Employee"
              desc="Create and manage daily orders, preview bills, and track active transactions efficiently."
            />
            <FeatureCard
              icon="📊"
              bg="bg-indigo-100"
              ...
              title="Manager"
              desc="Monitor store performance, manage staff schedules, handle inventory, and oversee supplier relations."
            />
            <FeatureCard
              icon="💳"
              bg="bg-yellow-100"
              ...
              title="Cashier / POS"
              desc="A lightning-fast, touch-friendly checkout interface with real-time cart calculations and receipt generation."
            />
            <FeatureCard
              icon="🛵"
              bg="bg-orange-100"
              ...
              title="Delivery"
              desc="View assigned orders, update delivery status in real-time, and navigate to customer locations seamlessly."
            />
            <FeatureCard
              icon="🧑‍💻"
              bg="bg-rose-100"
              ...
              title="Customer"
              desc="Browse the menu, manage your cart, place orders, track deliveries, and earn loyalty points — all online."
            />
          </div>
        </div>
      </section>
      ...
      <section id="careers" className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-12">
            We're always looking for passionate and dedicated people to be a
            part of the CoolStock family. Apply for the role that suits you
            best!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <CareerCard
              icon="📊"
              title="Manager"
              desc="Lead the team, oversee daily operations, and drive store performance."
            ...
            <CareerCard
              ...
              desc="Handle in-store transactions and deliver a great checkout experience."
            ...
            <CareerCard
              ...
              desc="Deliver our iconic scoops fresh and on time to happy customers."
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your favourite ice cream shop, powered by technology. Sweet every
              scoop.
            </p>
          </div>
          <div>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Cashier / POS Operator">💳 Cashier</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-purple-500 transition-colors resize-none"
                ></textarea>
              </div>
...
function FeatureCard({ icon, bg, border, title, desc }) {
  return (
    <div
      className={`hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(124,58,237,0.25)] transition duration-300 bg-white rounded-3xl p-7 text-left border ${border}`}
    >
      <div
        className={`w-12 h-12 ${bg} rounded-2xl flex items-center justify-center text-2xl mb-4`}
      >
        {icon}
      </div>
...
function CareerCard({ icon, gradient, border, badge, title, desc, onClick }) {
  return (
    <div
      onClick={onClick}
      className={`hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(124,58,237,0.25)] transition duration-300 bg-gradient-to-br ${gradient} rounded-3xl p-7 border ${border} text-left cursor-pointer`}
    >
      <div className="text-4xl mb-3">{icon}</div>
      <h3 className="text-lg font-bold text-gray-800 mb-1">{title}</h3>
      <p className="text-gray-500 text-sm mb-4">{desc}</p>
      <span
        className={`inline-block ${badge} text-xs font-semibold px-3 py-1 rounded-full`}
      >
        Apply →
      </span>
    </div>
