...
export default function DeliveryLayout() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="flex">
        {/* Sidebar */}
        <div className="w-64 h-screen bg-orange-700 text-white fixed flex flex-col justify-between z-10">
          <div>
            <div className="p-5 border-b border-orange-600 flex items-center gap-3">
            ...
            <nav className="mt-4 space-y-1 px-3">
              <Link to="/delivery/dashboard" className={navLinkClass('/delivery/dashboard')}>
                <span>🏠</span> My Orders
              </Link>
              <Link to="/delivery/profile" className={navLinkClass('/delivery/profile')}>
